...
public class Controller {
    ...
    public void showNewItemDialog() {
        ...
        if(result.isPresent() && result.get() == ButtonType.OK) {
            ...
            //todoListView.getItems().setAll(TodoData.getInstance().getTodoItems()); //nie potrzebe bo w TodoData jest ObservableList i samo sie updatuje
    ...
    public void handleClickListView() {
        ...
        //fxml ListView onMouseClick="#handleClickListView" //nie potrzebne bo jest bindowanie //addListener
    }

    public void deleteItem(TodoItem item) {
        Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
        alert.setTitle("Delete Task");
        alert.setHeaderText("Delete Task" +item.getShortDescription());
        alert.setContentText("Are you sure that you want to delete task? Press OK to confirm or CANCEL to go back");
